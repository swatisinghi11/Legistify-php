...
<html>
  ...
  <?php echo link_tag('bootstrap.min.css')?>
    ...
    <?php echo script_tag('navigate.js')?>
		...
		<title>Sign Up for Legistify</title>
	</head>
	<body>
    ...
    <br>
		<button type="submit" class="btn btn-info" style="width:100%" onclick="openURL(4)">Sign In</button>
    </div>
    </div>
		<div class="tag">
            ...
            <div class="col-sm-8">
              <input type="username" class="form-control" id="username" placeholder="Enter Username" required>
    			...
    			<div class="form-group">
  					...
  					<div class="col-sm-8">          
    					<input type="password" class="form-control" id="createPass" placeholder="Enter password" required>
      				</div>
    			</div>
              ...
              <br><br>
              <div id="error_msg" style="display:none;color:red;font-size:15px;text-align:center">Password does not match</div>
    			</div>
          <div class="form-group">
              <label class="control-label col-sm-2">Category:</label>
            <div class="col-sm-8">
                <select class="form-control" id="category" placeholder="Category" required>
                  <option value="0">Non-Lawyer</option>
		...
		<footer style="margin-left:1%;margin-top:1.5%;font-family: Lato">Copyright &copy; 2016 Legistify, All Rights Reserved. </footer>
	</body>
</html>