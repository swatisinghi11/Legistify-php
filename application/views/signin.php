...
<html>
	...
	<body>
		...
		<div class="tag">
			...
			<p style="font-size:20px;font-family:Lato;margin-left:40%;color:#514e4e;margin-top:0%">Sign in to continue to Legistify</p>
		</div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-8">
              <input type="username" class="form-control" id="username" placeholder="Enter Username" required>
    			...
    			<div class="form-group">        
      				<div class="col-sm-offset-2 col-sm-10">
        				<button type="submit" class="btn btn-primary" style="width:20%">Sign In</button>
        				<br><br>
		...
		<footer style="margin-left:1%;margin-top:2%;font-family: Lato">Copyright &copy; 2016 Legistify, All Rights Reserved. </footer>
